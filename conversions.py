# ESSE ARQUIVO NÃO ESTÁ SENDO MAIS UTILIZADO.
# SUA UTILIDADE É MOSTRAR COMO OBTEMOS O ARQUIVO DE GEOJSON QUE NOS 
# FORNECE A ENVOLTÓRIA DOS BAIRROS.


# necessitaria de pip install geopandas
