...
# Callback para realizar todas as mudanças no mapa ao alterar os Inputs
@callback(
...
def update_map(center_adr, search_range, shape):
    ...
    if shape == "retangulo": 
        ...
        return [markers + rectangle, table_data, [lat, lon]]
    ...
    #caso seja círculo usamos a função de busca correspondente 
        ...
        return [markers + circle, table_data, [lat, lon]]
    else:
        return no_update
